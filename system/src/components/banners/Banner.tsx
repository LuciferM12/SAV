...
const Banner = ({ height = '90vh', image, tipo, titulo, descripcion, secundario = false }: BannerProps) => {
    return (
        <div className="w-full flex bg-cover bg-center text-white bg-no-repeat items-center justify-center"
            style={{
            ...
            <div className='z-20 flex gap-3 w-[60%] flex-col items-center'>
                {
                    secundario ?
                        ...
                        <>
                            <h1 className='text-[3vmax] leading-none font-bold'>{tipo}</h1>
                            <h2 className='text-[4vmax] p-0 m-0 font-extrabold'>{titulo}</h2>
